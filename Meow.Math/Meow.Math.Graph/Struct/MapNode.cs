...
namespace Meow.Math.Graph.Class
{
    ...
    public struct MapNode<T> : IMapNode<T> where T : IEquatable<T>
    {
        /// <summary>
        /// 初始化节点
        /// </summary>
        ...
        public readonly bool Equals(IMapNode<T>? other) => other?.Id.Equals(Id) ?? false;
        public override readonly bool Equals([NotNullWhen(true)] object? obj) => obj is MapNode<T> other && Equals(other);
        public override readonly int GetHashCode() => Id.GetHashCode();
        public override readonly string ToString() => $"[Node:{Id}]";
        public static bool operator ==(MapNode<T> left, MapNode<T> right) => left.Equals(right);
        public static bool operator !=(MapNode<T> left, MapNode<T> right) => !left.Equals(right);
